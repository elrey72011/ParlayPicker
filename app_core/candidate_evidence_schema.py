...
FIELDS += ["football_feature_receipt", "football_feature_capture_status", "football_identity_status", "football_identity_observed_at", "football_identity_source_hash", "opposing_odds_american", "opposing_odds_source", "selection_probability_source", "ml_probability", "ml_probability_source",
...
line_consistency_flag line_event_identity_match_flag degraded_feature_subset_flag used_stale_features
suspicious_data_flag model_status stats_quality
provider_quotes provider_ids gamePk event_id season schedule_week
prospective_event_id quote_id prospective_quote_id quote_source_id quote_source_hash
model_id calibration_id validation_id validation_artifact_id sport_market_family deployment_state
...
controlled_trial_candidate controlled_trial_deterministic_eligible controlled_trial_gate_reason
controlled_trial_estimated_probability controlled_trial_break_even_probability
controlled_trial_estimated_price_edge controlled_trial_estimated_expected_value
controlled_trial_eligible controlled_trial_stake
""".split()))
