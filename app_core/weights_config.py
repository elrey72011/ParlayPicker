...
MLB_OVER_ACTIONABLE_MIN_EV = 0.05
MLB_OVER_ACTIONABLE_MIN_EDGE = 0.06
...
MLB_TOTAL_OVER_MIN_PRODUCTION_WIN_PROB = 0.57
...
EMPTY_CARD_RECOVERY_MIN_PRODUCTION_EV = 0.08
EMPTY_CARD_RECOVERY_MIN_PRODUCTION_EDGE = 0.05
EMPTY_CARD_RECOVERY_MIN_PRODUCTION_WIN_PROB = 0.58
EMPTY_CARD_RECOVERY_EXCLUDE_MARKET_TYPES = ["total_over"]
EMPTY_CARD_RECOVERY_EXCLUDE_SOURCES = ["upload", "rejected_live"]
