...
PIPELINE_BUILD = "2026-07-10c-batter-props-v1"
...
BEST_PICK_COLUMNS = [
    ...
    "uploaded_spread_line", "uploaded_total_line", "live_spread…92749 tokens truncated…or TOTAL generically
