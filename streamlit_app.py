# ParlayDesk_AI_Enhanced.py - v9.0
# AI-Enhanced parlay finder with sentiment analysis and ML predictions
...
def render_parlay_section_ai(title, rows):
    ...
    for i, row in enumerate(rows, start=1):
        ...
        with st.expander(
            ...
            st.dataframe(pd.DataFrame(legs_data), width="stretch", hide_index=True)
        ...
        with st.spinner(f"Analyzing {pp_sport} player props..."):
            ...
            for i, entry in enumerate(best_entries, start=1):
                ...
                with st.expander(
                    ...
                    st.dataframe(pd.DataFrame(picks_data), width="stretch", hide_index=True)
