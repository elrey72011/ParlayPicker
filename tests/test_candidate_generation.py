...
class TestCandidateGeneration(unittest.TestCase):
    ...
    def test_fallback_join_retains_uploaded_markets(self):
        theover_rows = pd.DataFrame([
            {
                "matchup_id": "different-id-but-same-teams", # mismatched exact ID
                "market_type": "spread_away",
                "league": "NBA",
                "home_team": "chicago bulls",
                "away_team": "miami heat",
        ...
        self.assertEqual(result.iloc[0]["orientation_source"], "fallback_match")
