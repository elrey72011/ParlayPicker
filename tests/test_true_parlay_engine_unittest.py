...
def leg(i, *, game=None, market='spread_away', selection=None):
    ...
    return dict(candidate_id=f'synthetic-c{i}-{market}', game_id=game or f'g{i}',
                ...
                quote_verified=True, production_eligible=True, market_family='TOTAL' if market.startswith('total_') else 'RUN_LINE',
                deployment_state='STANDARD_VALIDATED', validation_id='synthetic-straight-v1',
                validation_artifact_id='synthetic-straight-artifact-v1',
                model_id='synthetic-straight-model', model_version='m1',
                model_trained_through=at(-10000), model_available_at=at(-100),
                calibration_id='synthetic-straight-calibration', calibration_version='c1', calibration_available_at=at(-100),
