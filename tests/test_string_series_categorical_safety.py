...
def test_optimize_portfolio_allocation_handles_categorical_pick_status(monkeypatch):
    import app_core.weights_config as wc
    # Conservative path so the 4% pick cap holds; this test covers categorical-dtype
    # Pick_Status handling, not force-deploy sizing.
