...
def test_tiered_parlay_menu_includes_production_only():
    props = pd.DataFrame({
        "league": ["MLB"] * 5,
        ...
        "production_eligible": [True, True, False, False, False],
        "Stake_Status": ["Funded", "Funded"] + ["Qualified / No Stake"] * 3,
        "Kelly_Bet_Size": [1.0, 1.0, 0.0, 0.0, 0.0],
    })
