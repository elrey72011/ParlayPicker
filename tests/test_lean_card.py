...
# â”€â”€ Play stakes: every game playable at flat recreational units (owner, 4 Jul) â”€â”€
...
# â”€â”€ score_best_picks_rows: index-aligned tiers for the MAIN card (owner, 4 Jul) â”€â”€
...
def test_hopeless_prices_get_zero_play_stake():
    # CWS +5.5 at -1718 (4 Jul): Emp_Edge -0.35 â€” no recreational stake at any size.
    card = pd.DataFrame({
        "Matchup": ["A @ B", "C @ D"],
        "Tier": ["AVOID", "AVOID"],
        "Emp_Edge": [-0.35, -0.10],
